...
import com.pipo.webbansach_backend.entity.ThongBao;
...
public class TaiKhoanService {
    ...
    public ResponseEntity<?> kichHoatTaiKhoan(String email, String maKichHoat) {
        ...
        if (nguoiDung.isDaKichHoat()) {
            return ResponseEntity.badRequest().body(new ThongBao("Người dùng đã kích hoạt"));
        }
    ...
    private void guiEmailKichHoat(String email, String maKichHoat) {
        ...
        emailService.sendMessage("piniepinie0102@gmail.com", email, subject, text);
    }
}
